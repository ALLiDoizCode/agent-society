...
EVM_WORKFLOW_PRIVATE_KEY=${E2E_EVM_WORKFLOW_PRIVATE_KEY}
EVM_DVM_LIFECYCLE_PRIVATE_KEY=${E2E_EVM_DVM_LIFECYCLE_PRIVATE_KEY}
EVM_DVM_SUBMISSION_PRIVATE_KEY=${E2E_EVM_DVM_SUBMISSION_PRIVATE_KEY}
EVM_SWARM_PRIVATE_KEY=${E2E_EVM_SWARM_PRIVATE_KEY}
EVM_PET_DVM_PRIVATE_KEY=${E2E_EVM_PET_DVM_PRIVATE_KEY}
EVM_MILL_CLIENT_PRIVATE_KEY=${E2E_EVM_MILL_CLIENT_PRIVATE_KEY}
EVM_MILL_CLIENT_ADDRESS=${E2E_EVM_MILL_CLIENT_ADDRESS}
EOF
